...
AboutDialog::AboutDialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticText3 = new wxStaticText(this, ID_STATICTEXT3, _T("V1.1"), wxPoint(128,16), wxDefaultSize, 0, _T("ID_STATICTEXT3"));
	...
	StaticText5 = new wxStaticText(this, ID_STATICTEXT5, _T("2014.11.06"), wxPoint(192,96), wxDefaultSize, 0, _T("ID_STATICTEXT5"));
