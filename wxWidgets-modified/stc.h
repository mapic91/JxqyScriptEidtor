...
#define wxSTC_JXQY_GOTOPOS 2 //@xxx
#define wxSTC_JXQY_FUNCTION 3 // xxx(,,....)
#define wxSTC_JXQY_STRING 4
#define wxSTC_JXQY_OPERATOR 5
#define wxSTC_JXQY_VARIABLE 6
#define wxSTC_JXQY_NUMBER 7
#define wxSTC_JXQY_KEYWORD 8
#define wxSTC_JXQY_INDETIFIER 9
#define wxSTC_JXQY_COUNT 10
